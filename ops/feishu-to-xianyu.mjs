...
// ---------- 常量 ----------
const FEISHU_BASE_TOKEN = "PYtZbqyPyafc4sscwdjcQNLNnEh";
const FEISHU_TABLE_ID = "tblUcslarq5iLEPB";
const SSH = "xhs-windows";
const REGISTRY = "http://100.110.27.67:17930";
const REGISTRY_TOKEN = "zTmeS1QveLAvdVnhBIqEwTT3";
