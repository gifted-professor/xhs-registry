...
function summarizeCapability(capability, routingByCapability) {
  ...
  return {
    ...
    capabilityContractHashAlgorithm: capability.capabilityContractHashAlgorithm ?? null,
    implementationClosureHash: capability.implementationClosureHash ?? null,
    tcbManifestRef: capability.tcbManifestRef ?? null,
    policy,
