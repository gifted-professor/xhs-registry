...
6. 经 registry 确认隔离已清：`ssh xhs-windows 'curl.exe -s -H "x-registry-token: zTmeS1QveLAvdVnhBIqEwTT3" http://127.0.0.1:17930/api/agent-entry'` 中本设备 `state.quarantined=false`。
